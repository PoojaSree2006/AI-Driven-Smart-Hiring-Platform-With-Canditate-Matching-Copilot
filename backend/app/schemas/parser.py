...
class CandidateListItem(BaseModel):
    """
    Lightweight schema for table/list views (Candidates page,
    Recently Processed Candidates table) — avoids sending large
    fields like raw_text or full project descriptions over the wire

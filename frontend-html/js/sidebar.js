/* ==============================
   sidebar.js
   Reusable sidebar navigation — equivalent to React's components/Sidebar.jsx.
   Each page includes an empty <div id="sidebar"></div> and calls renderSidebar("current-page-id").
   ============================== */
...
const NAV_LINKS = [
  ...
  { id: "candidates", href: "candidates.html", label: "Candidates",
